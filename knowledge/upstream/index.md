...
* [group_sessions.py — Reconstructing Conversations](session-reconstruction.md) - The upstream prototype that groups flat request rows into per-session conversations, and the specific behaviors this project must preserve or repair.
