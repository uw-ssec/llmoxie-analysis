...
* [group_sessions.py — Reconstructing Conversations](session-reconstruction.md) - The upstream prototype that groups flat request rows into per-session conversations, its DataFrame and streaming code paths, and the specific behaviors this project must preserve.
