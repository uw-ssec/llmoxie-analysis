...
* [LiteLLM Spend Logs and infra extract](litellm-spend-logs.md) - The PostgreSQL-backed spend-log path, the REST endpoint that reads it, and the llmaven infra extract command that packages a date range into a zip.
